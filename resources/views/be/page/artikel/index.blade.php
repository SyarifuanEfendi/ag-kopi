...
<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
    <h4 class="page-title">Artikel</h4> </div>
            ...
            <div class="table-responsive">
                <table id="myTable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $datas+1 }}</td>
                            <td><img src="{{ asset('file/artikel/' . $entry->gambar) }}" width="150"/></td>
                            <td>{{ $entry->judul }}</td>
                            <td>{!! Str::limit( strip_tags( $entry->isi ), 200 ) !!}</td>
                            <td>
            ...
            <form id="form-contact" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-md-1 control-label">Judul</label>
                        <div class="col-md-11">
                    ...
                    <div class="form-group">
                        <label for="is_admin" class="col-md-1 control-label">Isi</label>
                        <div class="col-md-11">
